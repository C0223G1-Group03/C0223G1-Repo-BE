...
<body>
<nav class="navbar navbar-expand-lg bg-black sticky-top navbar-light p-3 shadow-sm" style="background: none">
    <div class="container">
        <a class="navbar-brand" href="/display"><span style="color: white"><i
                class="fa-solid fa-car"></i> <strong>VH3</strong></span></a>
        ...
        <div class="mx-auto my-3 d-lg-none d-sm-block d-xs-block">
            <div class="input-group">
                <span class="border-white input-group-text bg-white text-white"><i
        ...
        <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <div class="ms-auto d-none d-lg-block">
                <div class="input-group">
                    <span class="border-light input-group-text bg-light text-black"><i
                            class="fa-solid fa-magnifying-glass"></i></span>
                    <input type="text" class="form-control border-white" style="color:#7a7a7a">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link mx-2 text-uppercase text-center active text-white" aria-current="page"
                       href="/display">
                        <div>
            ...
            <ul class="navbar-nav ms-auto ">
                <li class="nav-item">
                    <a class="nav-link mx-2 text-uppercase text-white" href="/display?action=user"><i
                            class="fa-solid fa-circle-user me-1"></i> ĐĂNG NHẬP</a>
                </li>
            </ul>
        </div>
    </div>
