            ...
            <div class="pure-steps_group">
                <ol>
                    ...
                    <li class="pure-steps_group-step">
                        <fieldset>
                            ...
                            <p class="pure-steps_group-step_item flexy-item flexy-column reverse">
                                <label><input type="text" placeholder="abc123" name="account" id="input_account" required title="Vui lòng nhập tài khoản"></label>
                                <label for="input_account">Tên tài khoản</label>
                            </p>
                            <p class="pure-steps_group-step_item flexy-item flexy-column reverse">
                                <label><input type="password" placeholder="**********" name="password" id="input_password" required></label>
                ...
                <ol class="pure-steps_group-triggers">
                    <li class="pure-steps_group-triggers_item">
                        ...
                        <br>
                        <label style="padding-left: 290px;padding-top: 10px"><a href="/employee">Back</a></label>
                    </li>
                    <li class="pure-steps_group-triggers_item">
